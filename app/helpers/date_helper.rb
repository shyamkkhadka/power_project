# Helper module to convert english date to nepali and vice-versa
module DateHelper
  ...
  # # Usage : 
  # int[] npDateData = nepali_date_data_array(DateTime.now.year)
  # int npMonth = npDateData[0];
...
#   
  # def nepali_date_data_array(year)
    # # <summary>
