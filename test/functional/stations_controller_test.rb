...
class StationsControllerTest < ActionController::TestCase
  ...
  test "should create station" do
    assert_difference('Station.count') do
      post :create, station: { inc_address: @station.inc_address, inc_cell: @station.inc_cell, inc_name: @station.inc_name, name: @station.name, remarks: @station.remarks }
    end
  ...
  test "should update station" do
    put :update, id: @station, station: { inc_address: @station.inc_address, inc_cell: @station.inc_cell, inc_name: @station.inc_name, name: @station.name, remarks: @station.remarks }
    assert_redirected_to station_path(assigns(:station))
  end
