...
class BanksControllerTest < ActionController::TestCase
  ...
  test "should create bank" do
    assert_difference('Bank.count') do
      post :create, bank: { battery_id: @bank.battery_id, cells: @bank.cells, total_voltage: @bank.total_voltage, visual_inpsection: @bank.visual_inpsection }
    end
  ...
  test "should update bank" do
    put :update, id: @bank, bank: { battery_id: @bank.battery_id, cells: @bank.cells, total_voltage: @bank.total_voltage, visual_inpsection: @bank.visual_inpsection }
    assert_redirected_to bank_path(assigns(:bank))
  end
